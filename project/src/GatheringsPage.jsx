...
function GatheringsPage({ onNav }) {
  return (
    <>
      ...
      {/* DETAILS card */}
      <section style={{ background: BC.creamSubtle, padding: '80px 48px' }}>
      ...
      <Section bg={BC.white} py={120}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 72, alignItems: 'start' }}>
          <div style={{ position: 'sticky', top: 100 }}>
            ...
            <p style={{ fontFamily: fontBody, fontSize: 17, color: BC.navyMuted, lineHeight: 1.75, fontWeight: 300, marginBottom: 28 }}>
              Come as you are. Dress however. Bring your coffee — we'll have more when you arrive.
            </p>
          </div>
          <div>
      ...
      <section style={{ background: BC.creamSubtle, padding: '120px 48px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <FAQList items={[
            ...
            { q: 'What should I wear?', a: 'Whatever you\'re comfortable in. Some people wear jeans, some wear flannels, some wear suits. We don\'t care.' },
